...
df_all['Percentage of Colocalization'] = df_all.coloc_percent_PB + df_all.coloc_percent_HOPS
...
plt.title('RNA Colocalization with HOPS Condensates (per FOV)')
plt.tight_layout()
os.chdir(folderpath_save)
plt.savefig('RNA Colocalization with HOPS Condensates_perfov.png', format='png')
